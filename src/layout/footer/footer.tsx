...
export const Footer = () => {
  return (
    <footer className="bg-flamingo-lighter rounded-t-4xl py-12 md:pt-16">
      ...
      <div className="text-muted-foreground border-flamingo mt-20 flex flex-col justify-between gap-4 border-t px-4 pt-8 text-center text-sm font-medium lg:flex-row lg:items-center lg:text-left">
