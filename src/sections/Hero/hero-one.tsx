...
const Hero1 = ({
  ...
  return (
    <section className="from-flamingo-lighter to-chateau-lightest border-flamingo-lighter bg-gradient-to-br px-6 py-4">
      <div className="relative mx-auto max-w-7xl rounded-2xl px-16 py-8 shadow-md">
