...
export default function HeroSplitImageForm() {
        ...
        <div className="grid grid-cols-1 items-center justify-center gap-20 lg:grid-cols-2">
          <div>
            <div className="flex max-w-[40.625rem] flex-col gap-8">
              <h1 className="text-foreground text-4xl font-bold lg:text-5xl xl:text-6xl">
              ...
              {/* Formulaire adapté avec le composant Input */}
                  ...
                  <div className="w-full flex-1">
                    <div className="relative w-full">
                      <Input
                        ...
                        className="h-auto py-5 pl-11"
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        required
                      />
                      <Mail className="text-muted-foreground absolute top-1/2 left-5 size-4 -translate-y-1/2" />
                    </div>
                  </div>
                  <div className="w-full shrink-0 md:w-fit">
                    <Button
                      type="submit"
                      className="h-auto w-full cursor-pointer px-8 py-5 font-semibold md:w-fit"
                    >
                      Get Started
                    </Button>
                  </div>
              ...
              <div className="flex flex-col gap-1.5 py-4">
                <div className="flex items-center gap-2">
                  <svg
                    ...
                    className="lucide lucide-check stroke-muted2-foreground size-4"
                  >
                    <path d="M20 6 9 17l-5-5"></path>
                  </svg>
                  <p className="text-muted-2-foreground text-lg font-medium">
          ...
          <div>
            <div className="relative mx-auto aspect-[0.990343348_/_1] w-full max-w-[42.5rem]">
              <div className="absolute top-[5.04%] left-[4.33%] z-20 w-[42.25%]">
                <div
                  style={{
                    position: "relative",
                    width: "100%",
                    paddingBottom: "116.6666666861111%",
                  }}
                >
                  <div
              ...
              <div className="absolute right-[8.23%] bottom-[12.87%] z-20 w-[42.25%]">
                <div
                  style={{
                    position: "relative",
                    width: "100%",
                    paddingBottom: "126.66666670044445%",
                  }}
                >
                  <div
                    data-slot="aspect-ratio"
              ...
              <div className="absolute bottom-[5%] left-[10.94%] z-30 w-[42.25%]">
                <div
                  style={{
                    position: "relative",
                    width: "100%",
                    paddingBottom: "111.79487177537935%",
                  }}
                >
                  <div
                    data-slot="aspect-ratio"
                  ...
                  >
                    <img
                      src="https://library.shadcnblocks.com/images/block/placeholder-dark-3.svg"
                      alt=""
                      className="block size-full object-cover"
                    />
                  </div>
              ...
              <svg
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="lucide lucide-star absolute top-[15%] right-[16%] size-[4%] stroke-sky-500"
              >
