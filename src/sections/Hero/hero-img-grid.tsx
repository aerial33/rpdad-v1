        ...
        <div className="container grid grid-cols-1 gap-4 px-4 md:px-0 lg:grid-cols-4 lg:gap-8">
          <div className="mb-8 self-end lg:col-span-2 lg:col-end-3 lg:mb-0">
            <div className="mb-8 flex flex-col">
              ...
              <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-xl">
                ...
                Centres Communaux d'Action Sociale de la Gironde) <br /> Aide à
                la vie quotidienne pour les personnes âgées ou en situation de
                handicap
              </p>
          ...
          <div className="lg:col-span-2 lg:col-end-5">
            <div className="relative">
              ...
              <svg
                className="absolute -top-[5%] left-[15%] -z-10 w-[60%]"
                viewBox="0 0 588 655"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                transform="scale(-1,1)"
